...
export default function Home() {
  return (
    <main className="bg-gradient-to-bl from-white to-indigo-600 flex-1 overflow-y-scroll p-2 lg:p-5">
        ...
        <div className="flex flex-col justify-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br />
              Upload you document, and our chatbot will answer questions,
              ...
              enhancing productivity 10x fold effotlessly.
            </p>
          </div>

          <Button asChild className="mt-10 w-fit mx-auto">
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <Image
              ...
              width={2432}
              height={1442}
              className="mb-0 rounded-xl shadow-2xl ring-1 ring0gray-900/10"
            />

            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 bg-gradient-to-t -inset-x-32 from-white/95 pt-[5%]" />
            </div>
          </div>
        </div>

        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-o lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
